 ...
 * Class ExtendedAsset
 *
 * PDF Generator plugin for Craft CMS 5.
 *
 ...
 * @since     3.0.0
 */
class ExtendedAssetv5 extends Asset
{
    public $assetThumb;
    private $_url;
    private $_isDraft;
    ...
    {
        return $this->_cpEditUrl ?? parent::getCpEditUrl();
    }
    public function setCpEditUrl($cpEditUrl)
    {
        $this->_cpEditUrl = $cpEditUrl;
    }
